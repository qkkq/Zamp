...
namespace geom {
  ...
  inline
  int Sgn(double Val) {
    return Val > ERR_DOUBLE ? 1 : Val < -ERR_DOUBLE ? -1 : 0;
  }
  ...
  template < typename Type, unsigned int Size >
    class Vector {
       ...
       */
      Vector < Type, Size > operator + (Vector < Type, Size >
        const & rSkl2) const;
       ...
       *         i \e rVec.
       */
      Type operator & (Vector < Type, Size >
        const & rVec) const; // skalar product
       ...
       */
      bool operator == (Vector < Type, Size >
        const & rArg2);
       ...
       * \return  false - w przypadku przeciwnym.
       */
      bool IsInside(Vector < Type, Size >
        const & Min, Vector < Type, Size > Max) const;
      ...
      void Normalize() {
        Type d = Length();
        for (Type & Crd: _Coord) Crd /= d;
      }
    };

  template < typename Type, unsigned int Size >
    inline
  bool Vector < Type, Size > ::IsInside(Vector < Type, Size >
    const & Min, Vector < Type, Size > Max) const {
  ...
  template < typename Type, unsigned int Size >
    inline
  Vector < Type, Size > & Vector < Type, Size > ::operator += (Vector < Type, Size >
    const & rSkl2) {
  ...
  template < typename Type, unsigned int Size >
    inline
  Vector < Type, Size > Vector < Type, Size > ::operator + (Vector
    const & rSkl2) const {
  ...
  template < typename Type, unsigned int Size >
    inline
  bool Vector < Type, Size > ::operator == (Vector < Type, Size >
    const & rArg2) {
  ...
  template < typename Type, unsigned int Size >
    inline
  Type Vector < Type, Size > ::operator & (Vector < Type, Size >
    const & rVec) const {
    Type Res = 0;
